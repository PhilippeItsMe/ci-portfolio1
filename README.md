...
The goal of the website is to generate lead by inviting people to send a form to have a deeper presentation and understanding of the service.
...
<ul>
    <li>Navigation bar -> to navigate inside the page, a smooth scolling js code is in place to make the move pleasant</li>
    <img style="width: 300px" src="assets/images/screenshot-nav.webp">
    <li>Header ->to have a brief description of the service, to understand the global benefit to use it</li>
    <img style="width: 300px" src="assets/images/screenshot-header.webp">
    <li>How easy -> to understand users benefits, to understand the secondary wins with this solution</li>
    <img style="width: 300px" src="assets/images/screenshot-benefit.webp">
    <li>4 steps -> to understant the process of the service in 4 steps</li>
    <img style="width: 300px" src="assets/images/screenshot-process.webp">
    <li>Testimonials -> to have social proofs (generated by IA) to consolidate the image of the company</li>
    <img style="width: 300px" src="assets/images/screenshot-testimonials.webp">
    <li>Let's discuss your need -> to have a easy to use CTA or contact form</li>
    <img style="width: 300px" src="assets/images/screenshot-form.webp">
    <li>Footer -> to have a easy acess to our contact data</li>
...
NEW : adding Favicon
NEW : adding dB behing the form

#### JAVASCRIPT
NEW : adding smooth scrolling
